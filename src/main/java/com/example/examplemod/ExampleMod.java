...
public class ExampleMod {
    ...
    private void setup(final FMLCommonSetupEvent event) {
        // Register entity spawn placement
        event.enqueueWork(() -> {
            SpawnPlacements.register(ModEntities.AGENT.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                EntityAgent::checkSpawnRules);
        });

        // Some preinit code
        LOGGER.info("Example Mod setup phase");
    ...
    public void entityAttributeEvent(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.AGENT.get(), EntityAgent.createAttributes().build());
    }
